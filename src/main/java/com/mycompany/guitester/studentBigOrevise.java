 ...
 * @author hurle
 */
public class studentBigOrevise extends javax.swing.JFrame {

    /**
     * Creates new form studentBigOrevise
     */
    public studentBigOrevise() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(studentMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 640, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentBigOrevise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
