 ...
 * @author hurle
 */
public class studentBigOPastQuestions extends javax.swing.JFrame {

    /**
     * Creates new form studentBigOPastQuestions
     */
    public studentBigOPastQuestions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        studentMenu.setMaximumSize(new java.awt.Dimension(200, 95));
        studentMenu.setMinimumSize(new java.awt.Dimension(200, 95));
        ...
        getContentPane().add(studentMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 640, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentBigOPastQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
