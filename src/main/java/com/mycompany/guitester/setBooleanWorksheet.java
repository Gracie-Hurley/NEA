 ...
 * @author hurle
 */
public class setBooleanWorksheet extends javax.swing.JFrame {

    /**
     * Creates new form setBooleanWorksheet
     */
    public setBooleanWorksheet() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(menuButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 640, 190, 100));
        ...
        getContentPane().add(returnButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 640, 190, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(setBooleanWorksheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
