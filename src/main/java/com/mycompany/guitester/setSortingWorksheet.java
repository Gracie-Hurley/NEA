 ...
 * @author hurle
 */
public class setSortingWorksheet extends javax.swing.JFrame {

    /**
     * Creates new form setSortingWorksheet
     */
    public setSortingWorksheet() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(menuButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 640, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(setSortingWorksheet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
