 ...
 * @author hurle
 */
public class studentSortingPastQuestions extends javax.swing.JFrame {

    /**
     * Creates new form studentSortingPastQuestions
     */
    public studentSortingPastQuestions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(returnButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 650, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentSortingPastQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
