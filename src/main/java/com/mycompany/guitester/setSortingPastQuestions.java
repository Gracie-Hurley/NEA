 ...
 * @author hurle
 */
public class setSortingPastQuestions extends javax.swing.JFrame {

    /**
     * Creates new form setSortingPastQuestions
     */
    public setSortingPastQuestions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(menuButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 650, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(setSortingPastQuestions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
